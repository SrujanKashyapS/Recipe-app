...
const About = () => {
  return (
    <section className="px-6 lg:px-12 py-20">
      <h1 className="text-center text-3xl pt-10 pb-4 front-semibold text-secondary sm:text-6xl sm:leading-relaxed">
        About
      </h1>
      <p className="text-center sm:w-1/2 mx-auto mb-20">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit eum
        obcaecati molestiae magnam quasi natus cumque ipsa, sequi veniam? Quas
        repellendus incidunt facilis cupiditate ducimus. Doloribus qui maiores
        quia consequatur.
      </p>
      ...
      <div className="container mx-auto px-6 py-40">
        <div className="flex flex-col md:flex-row items-center justify-between relative w-100 h-auto md:h-64 bg-white shadow-2xl rounded-lg p-8">
          <div className="w-8/12 text-2xl">
            ...
            <span className="flex">
              We are team of developers with hundreds hours spend on coding, we
